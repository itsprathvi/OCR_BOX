function runOnLoad() {
    ...
    let inputImageDiv = document.getElementsByClassName("inputImageDiv")[0];
    let inputImageCanvas = document.getElementsByClassName("inputImageCanvas")[0];
    let imgToBeCropped = document.getElementById("file-ip-1-preview");
    let grid = document.getElementById("grid");

    inputImageDiv.style.width = imgToBeCropped.clientWidth + 'px';
    inputImageDiv.style.height = imgToBeCropped.clientHeight + 'px';
    inputImageDiv.style.maxWidth = imgToBeCropped.clientWidth + 'px';
    inputImageDiv.style.maxHeight = imgToBeCropped.clientHeight + 'px';

    grid.style.width = imgToBeCropped.clientWidth + 'px';
    grid.style.height = imgToBeCropped.clientHeight + 'px';
    grid.style.maxWidth = imgToBeCropped.clientWidth + 'px';
    grid.style.maxHeight = imgToBeCropped.clientHeight + 'px';

    inputImageCanvas.style.width = imgToBeCropped.clientWidth + 'px';
    inputImageCanvas.style.height = imgToBeCropped.clientHeight + 'px';
    inputImageCanvas.style.maxWidth = imgToBeCropped.clientWidth + 'px';
    inputImageCanvas.style.maxHeight = imgToBeCropped.clientHeight + 'px';
